...
var chartSemiDonutColors=getChartColorsArray("semi_donut_chart_modal");chartSemiDonutColors&&(options={series:[68,55],chart:{height:480,type:"donut"},plotOptions:{pie:{startAngle:-90,endAngle:90}},dataLabels:{enabled:!1},legend:{show:!1},labels:["Total ISSQN","Total Revisado"],colors:chartSemiDonutColors,responsive:[{breakpoint:480,options:{chart:{width:900}}}]},document.querySelector("#semi_donut_chart_modal")&&(chart=new ApexCharts(document.querySelector("#semi_donut_chart_modal"),options)).render());
var chartPieBasicColors=getChartColorsArray("simple_pie_chart");chartPieBasicColors&&(options={series:[46,54],chart:{height:250,type:"pie"},dataLabels:{enabled:!1},legend:{show:!1},labels:["Total ISSQN","Total Revisado"],colors:chartPieBasicColors},(chart=new ApexCharts(document.querySelector("#simple_pie_chart"),options)).render());
var chartPieBasicColors=getChartColorsArray("simple_pie_chart_modal");chartPieBasicColors&&(options={series:[46,54],chart:{height:450,type:"pie"},dataLabels:{enabled:!1},legend:{show:!1},labels:["Total ISSQN","Total Revisado"],colors:chartPieBasicColors},(chart=new ApexCharts(document.querySelector("#simple_pie_chart_modal"),options)).render());